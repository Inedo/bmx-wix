...
namespace Inedo.BuildMasterExtensions.WiX.GenerateComponents
{
    ...
    /// </summary>
    [ActionProperties("Generate Components", "Generates a WiX fragment based on the files in a directory.", "WiX")]
    [CustomEditor(typeof(GenerateComponentsActionEditor))]
